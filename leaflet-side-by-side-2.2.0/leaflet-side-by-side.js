        ...
        (function (global) {
          ...
          L.Control.SideBySide = L.Control.extend({
            ...
            _updateClip: function () {
              ...
              this._addEvents("dividermove", { x: dividerX });
              var clipLeft =
            ...
            _updateLayers: function () {
              ...
              if (prevLeft !== this._leftLayer) {
                prevLeft &&
                  this._addEvents("leftlayerremove", { layer: prevLeft });
                this._leftLayer &&
                  this._addEvents("leftlayeradd", { layer: this._leftLayer });
              }
              if (prevRight !== this._rightLayer) {
                prevRight &&
                  this._addEvents("rightlayerremove", { layer: prevRight });
                this._rightLayer &&
                  this._addEvents("rightlayeradd", { layer: this._rightLayer });
              }
              this._updateClip();
            },
